...
/*--------------------------------PINS-------------------------------------------*/
#define ANOMALY_TERMINAL GPIO3  // 1 anomaly / 0 no anomaly
/*-----------------------------------------------------------------------------*/
...
void setup()
{
    pinMode(ANOMALY_TERMINAL, OUTPUT); 
...
void loop()
{
    ...
    if (result.anomaly > 2) {
      digitalWrite(ANOMALY_TERMINAL, HIGH);
      delay(500);
      digitalWrite(ANOMALY_TERMINAL, LOW);
    }
    else{
      digitalWrite(ANOMALY_TERMINAL, LOW);
