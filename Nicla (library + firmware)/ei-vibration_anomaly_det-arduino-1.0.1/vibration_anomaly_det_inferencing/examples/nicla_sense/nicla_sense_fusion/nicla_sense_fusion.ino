#include <vibration_anomaly_det_inferencing.h>
...
/*--------------------------------PINS-------------------------------------------*/
#define CONTROL 13  // control
#define ANOMALY_PIN 14  // 1 anomaly / 0 no anomaly
...
void loop()
{
    ...
    if (result.anomaly>2) {
      digitalWrite(ANOMALY_PIN,HIGH);
    }
    else{
      digitalWrite(ANOMALY_PIN,LOW);
    }
